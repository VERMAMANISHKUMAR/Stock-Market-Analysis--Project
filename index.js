const stocks = [
        ...
        function createLineChart(displayData, timeStamp) {
          ...
          const dateTime = timeStamp.map((time) =>
        ...
        function updateCompany(chart, newData, currTimeline) {
          ...
          const formatDate =
            allStockData.stocksData[0][currCompany][currTimeline].timeStamp;
          const dateTime = formatDate.map((time) =>
            new Date(time * 1000).toLocaleDateString()
          );
        ...
        async function fetchAllStockData() {
          try {
            ...
            const stockSummaryApi = await fetch(
            ...
            const initialTimeStamp =
              allStockData.stocksData[0]["AAPL"]["1mo"].timeStamp;
